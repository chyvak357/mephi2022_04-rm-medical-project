...
CREATE TABLE IF NOT EXISTS `hospital`.`doctors` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  UNIQUE INDEX `phone_numb_UNIQUE` (`phone_numb` ASC) VISIBLE,
  INDEX `id_idx` (`cabinet_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `hospital`.`registration_coupon` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `id_idx` (`doctors_id` ASC) VISIBLE,
  INDEX `id_idx1` (`patients_id` ASC) VISIBLE,
  INDEX `id_idx2` (`patients_med_card_id` ASC) VISIBLE,
  INDEX `id_idx3` (`patients_health_insurance_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `hospital`.`patients` (
  ...
  UNIQUE INDEX `phone_numb_UNIQUE` (`phone_numb` ASC) VISIBLE,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `health_insurance_fk_idx` (`health_insurance_id` ASC) VISIBLE,
  INDEX `med_card_fk_idx` (`med_card_id` ASC) VISIBLE,
  CONSTRAINT `health_insurance_fk`
